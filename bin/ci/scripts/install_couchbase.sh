...
sudo apt-get update
sudo apt-get install -yq libcouchbase3 libcouchbase-dev build-essential libssl3 runit wget python3-httplib2 chrpath tzdata lsof lshw sysstat net-tools numactl libtinfo
